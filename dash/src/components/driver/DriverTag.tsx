	...
	return (
		...
		>
			...
			<div className="flex">
				...
				<div className="flex h-min w-min items-center justify-center rounded-md bg-white px-1" style={{marginLeft:"-10px"}} >
					<p className="font-mono text-zinc-600" style={{ ...(teamColor && { color: `#${teamColor}` }), fontSize: "small"}}>
						{short}
					</p>
				</div>
			</div>
